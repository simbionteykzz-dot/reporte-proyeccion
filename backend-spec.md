...
│
├── assets/
│   ├── style.css            # Design system (variables CSS)
│   ├── dashboard.js         # Lógica UI + manejo de estado
│   └── charts.js            # Configuración Chart.js
│
├── templates/
│   └── reporte_tabla.html   # Template Jinja2 (fallback)
│
├── frontend/                # React SPA (dist para producción)
│   ├── src/
│   │   ├── components/
│   │   ├── hooks/
│   │   └── lib/
│   └── dist/
│
└── .cursor/skills/          # Skills de agentes especializados
```
